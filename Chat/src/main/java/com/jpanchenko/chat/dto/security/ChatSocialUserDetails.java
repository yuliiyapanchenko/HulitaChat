 ...
 */
public class ChatSocialUserDetails extends SocialUser implements ChatUserDetails {
    ...
    public ChatSocialUserDetails(String username, String password, Collection<? extends GrantedAuthority> authorities) {
    ...
    public static class Builder {
        ...
        public ChatSocialUserDetails build() {
            ChatSocialUserDetails user = new ChatSocialUserDetails(username, password, authorities);
            user.id = id;
